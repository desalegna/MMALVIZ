"""
ProtoKrum Defense Against Backdoor Attacks in Federated Few-shot Learning.
"""
...
class Config:
    ...
    # MMALVIZ dataset folders (api_call_images/, network_traffic_images/)
    # at the top level.
    API_IMAGE_DIR     = os.environ.get("API_IMAGE_DIR", "api_call_images")
    TRAFFIC_IMAGE_DIR = os.environ.get("TRAFFIC_IMAGE_DIR", "network_traffic_images")
    RESULTS_DIR       = os.environ.get(
        "RESULTS_DIR", os.path.join(SCRIPT_DIR, "results_ProtoKrum_defense"))
