"""
Coordinate-wise Median Aggregation Baseline (Federated Learning).

Element-wise median across all client parameters — a Byzantine-robust
baseline with no prototype/cosine-deviation scoring, for comparison
against ProtoKrum. Reference: Yin et al., "Byzantine-Robust Distributed
    ...
    try:
        ...
        for poison_rate in POISONING_RATES:
            ...
            for n_shot in [1, 5]:
                ...
                run_dir = os.path.join(rate_dir, f'{n_shot}shot_median')
