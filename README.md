...
├── ProtoKrum.py                  
├── ProtoKrum_malimg.py            # ProtoKrum evaluated on MalImg
├── ProtoTrimmed.py              
├── ProtoTrimmed_malimg.py         # ProtoTrimmed evaluated on MalImg
├── FedAvg.py                      
├── FedAvg_malimg.py               # FedAvg evaluated on MalImg
├── FoolsGold.py                 
├── FoolsGold_malimg.py            # FoolsGold evaluated on MalImg
├── Median.py                      
├── Median_malimg.py               # Median evaluated on MalImg
├── Multi-Krum.py                
├── Multi-Krum_malimg.py           # Multi-Krum evaluated on MalImg
├── RFA.py                        
├── RFA_malimg.py                  # RFA evaluated on MalImg
├── README.md
├── LICENSE
├── requirements.txt
├── metadata.csv              
